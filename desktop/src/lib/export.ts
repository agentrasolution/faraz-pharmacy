...
export function downloadExcel(
  ...
  const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>${title}</title>
    <style>
      ...
      h2 { color: #4A25E1; margin-bottom: 16px; font-weight: 700; letter-spacing: -0.5px; }
    ...
    <p style="font-size:11px;color:#9ca3af;margin-top:16px">Generated by Faraz Pharmacy Enterprise POS</p>
    <script>
